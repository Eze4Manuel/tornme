...
export const UsersDistributionCard = (props) => {

    return (
        <div className="usersDistribution-card">
            <div className="usersDistribution-cards-top">
                <span className="usersDistribution-cards-top-title-left">
                    {props.topLeft}
                </span>
